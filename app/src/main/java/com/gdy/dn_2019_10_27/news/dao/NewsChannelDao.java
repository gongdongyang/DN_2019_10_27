package com.gdy.dn_2019_10_27.news.dao;
...
import com.gdy.dn_2019_10_27.database.DatabaseHelper;
...
public class NewsChannelDao {
    ...
    public void addInitData() {
        String categoryId[] = YApplication.getInstance().getResources().getStringArray(R.array.mobile_news_id);
        String categoryName[] = YApplication.getInstance().getResources().getStringArray(R.array.mobile_news_name);
    ...
    public List<NewsChannelEntitiy> query(int isEnable) {
        Cursor cursor = db.query(NewsChannelTable.TABLENAME,null,
                NewsChannelTable.IS_ENABLE + "=?",
                new String[]{isEnable + ""}, null, null, null);

        List<NewsChannelEntitiy> list = new ArrayList<>();

        while (cursor.moveToNext()) {
            NewsChannelEntitiy bean = new NewsChannelEntitiy();
    ...
    public List<NewsChannelEntitiy> queryAll() {
    ...
    public void updateAll(List<NewsChannelEntitiy> list) {
